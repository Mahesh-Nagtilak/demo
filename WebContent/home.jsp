...
<html lang="en">
 ...
 <head>
    ...
    <title>Great indian Airlines</title>
  ...
  <body style="background: -webkit-radial-gradient(rgb(118, 10, 138), rgb(5, 11, 18));background: radial-gradient(rgb(118, 10, 138), rgb(5, 11, 18));height:100%; min-height:100%;margin:0;padding:0;" >
	...
	<header>
	<!--Navigation Bar-->
    <nav class="navbar navbar-expand-md navbar-dark font-weight-bold nav justify-content-center nav-justified" style="background:url('./assets/img/dashboard.jpg'); border:3px solid black;">
      <a class="navbar-brand" href="home.jsp">
	  	<img src="https://turkishairlines.ssl.cdn.sdlmedia.com/636373437847588165FE.png" alt="Great indian Airlines Logo">
   ...
   <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-pause="false" style="border-bottom:3px solid black; margin-bottom:1px;">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img class="d-block" src="./assets/img/status.jpg" alt="First slide">
			<div class="carousel-caption d-md-block text-top">
				<h1>Welcome to Great Indian Airlines!</h1>
			</div>
		</div>
		
		<div class="carousel-item">
			<img class="d-block img-fluid" src="./assets/img/228661.jpg" alt="Second slide">
		...
		<div class="carousel-item">
			<img class="d-block img-fluid" src="./assets/img/383671.jpg" alt="Third slide">
			<div class="carousel-caption d-md-block">
				<h1>Awarded the best Asian Airlines for 2020-21!</h1>
			</div>
		</div>
	</div>
